...
func (m *MockIHealthRepository) AddData(ctx context.Context, userId string, timestamp int64, healthScore int, comment string) (*healthRepository.Health, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddData", ctx, userId, timestamp, healthScore, comment)
...
func (mr *MockIHealthRepositoryMockRecorder) AddData(ctx, userId, timestamp, healthScore, comment any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddData", reflect.TypeOf((*MockIHealthRepository)(nil).AddData), ctx, userId, timestamp, healthScore, comment)
}
